...
\item. Let $\inst_1=(z_1,0,\hash(\emptyacc))$, $w_1=(\emptyacc,\emptyacc, \inst_0, \wit_0, \pi)$. Here $inst_0$ satisfies $inst_0.z=z_0$, and doesn't need to be a satisfiable instance.
