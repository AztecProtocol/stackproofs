...
We assume in this section $(F,\finpred)$ is trivial, thinking of it as equal to $(F^*,f\finpred^*)$ from Section \ref{sec:Fstar}
...
\begin{itemize}
 ...
 \item $\witfin = (\accwit,\accprev,\inst)$
\end{itemize}
such that
\begin{enumerate}
...
$(\acc_i,\accwit_i,\pi_i) = P_{PG}(\acc_{i-1},\accwit_{i-1},\inst_{i-1},\wit_{i-1})$
$\inst_i = (z_i,i-1,\hash(\acc_i)), w_i=(X_i,X_{i-1},x_{i-1},\wit{i-1},\prf_i)$
