...
We can have the note operations - \set{\add, \read, \del} - performed by a function be included in the public inputs of its circuit.
...
We fix a polynomial $G:\F^8\to \F$, and integers $N,k$ that are implicit parameters in the following definition of the relation \relapp.
...
\item  Choose instance $\inst_0=(z_0,\cnt_0,\acchash_0)$ for arbitrary values $\cnt_0,\acchash_0$. Let $\inst_1=(z_1,0,\hash(\emptyacc))$, $\omega_1=(\emptyacc,\emptyacc, \inst_0, \wit_0, \prf)$.
