...
\begin{enumerate}
 ...
 \begin{enumerate}
  \item If $(\inst_i,\wit_i)\notin \rel$, output \empt and abort. Othewise, as $(\inst_i,\wit_i)\in \rel$ implies  $\acc_{i},\inst_{i}\in K$, let $\witacc_{i},\witinst_{i}$ be the elements output by \adv such that $\acc_i= \cm(\witacc_{i}),\inst_i=\cm(\witinst_i)$.
...
For $i\in [n]$, let $E_i$ be the event $(\inst_i,\witinst_i)\notin \rel$.
%  \item  $D_i:\acc'_i\neq \acc_i$.
