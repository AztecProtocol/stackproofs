...
\newcommand{\acchash}{\ensuremath{\mathpgoth{h}}\xspace}
...
% $z$ - output for $F$
% $\cnt$ - counter of IVC step
% \acchash - supposed hash of accumulator
% **private input:**
% $\witFprime=(\instt,\insttbase,\inst,\witF,\prf)$
% $\instt$ - current accumulator instance
% $\instbase$ - previous accumulator instance
% $\inst$ - instance (of $F'$) to be accumulated.
% $\witF$ - private input for $F$
% $\prf$ - proof for protogalaxy verifier
% 
