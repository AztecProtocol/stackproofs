...
Fixed polynomial $f(x_1,\ldots,x_S)$
$S=n+d+\ell$
...
Some choices of constants - like the maximal number of inner calls per function being two, are abitrary.
...
As in \cite{nova,othernova}, we describe an extended function $F'$ that includes the \protogal verifier.
